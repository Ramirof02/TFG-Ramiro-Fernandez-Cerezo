"""
Experimento 5: Overlap con Muestreo de Difíciles
================================================
...
RESULTS_DIR = f"./resultados/exp5_results_{config.name}"
...
def main():
    print("="*70)
    print(f"EXPERIMENTO 5: Overlap con Muestreo de Difíciles - {config.name}")
    print("="*70)
    ...
    print("Estrategia: Fase actual + 30% más difíciles anteriores (hard mining)")
    ...
    results = {
        'experiment': 'exp5_solape_dificiles',
        'strategy': 'Overlap: fase actual + 30% difíciles anteriores',

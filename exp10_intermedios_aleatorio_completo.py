"""
Experimento 10: Intermedios + Aleatorio Completo
=================================================
Curriculum con SOLO niveles intermedios (3-7) + Muestreo aleatorio completo.
Fase actual + 30% completamente aleatorio de TODAS las fases anteriores.
...
Estructura:
  Fase 1: [3]
  Fase 2: [4] + 30% aleatorio de fase 1
  Fase 3: [5] + 30% aleatorio de fases 1-2
  Fase 4: [6] + 30% aleatorio de fases 1-3
  Fase 5: [7] + 30% aleatorio de fases 1-4
...
RESULTS_DIR = f"./resultados/exp10_results_{config.name}"
...
def main():
    print("="*70)
    print(f"EXPERIMENTO 10: Intermedios + Aleatorio Completo - {config.name}")
    print("="*70)
    ...
    print("\nEstrategia: Niveles intermedios (3-7) + 30% aleatorio de TODAS las fases anteriores")
    ...
    for phase in range(N_PHASES):
        ...
        if phase == 0:
            ...
            print(f"Nivel actual: {current_levels}")
            print(f"+ 30% aleatorio de niveles anteriores: {previous_levels}")
    ...
    results = {
        'experiment': 'exp10_intermedios_aleatorio_completo',
        'strategy': 'Intermedios (3-7) + 30% aleatorio total',

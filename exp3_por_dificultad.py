"""
Experimento 3: Por Niveles de Dificultad
========================================
Curriculum learning clásico: progresión estricta fácil→difícil.\nSin overlap entre fases.\nBengio et al. (2009).

ACTUALIZADO: Usa estructura train/val separada

Ejecutar: python exp3_por_dificultad.py
"""
...
RESULTS_DIR = f"./resultados/exp3_results_{config.name}"
...
# Niveles por fase (10 niveles total)
PHASE_LEVELS = [
    [0, 1],        # Fase 1: Muy fácil
    [2, 3],        # Fase 2: Fácil
    [4, 5],        # Fase 3: Medio
    [6, 7],        # Fase 4: Difícil
    [8, 9]         # Fase 5: Muy difícil
]
...
def main():
    print("="*70)
    print(f"EXPERIMENTO 3: Por Niveles de Dificultad - {config.name}")
    print("="*70)
    ...
    print("Estrategia: Progresión fácil → difícil (sin overlap)")
    ...
    results = {
        'experiment': 'exp3_por_dificultad',
        'strategy': 'Curriculum: fácil → difícil sin overlap',

"""
Experimento 8: Curriculum Intermedios Acumulativo
=================================================
Curriculum learning con SOLO niveles intermedios (3-7).
Progresión acumulativa con overlap 100%.
...
Estructura:
  Fase 1: [3]
  Fase 2: [3, 4]           ← Acumula anteriores
  Fase 3: [3, 4, 5]        ← Acumula anteriores
  Fase 4: [3, 4, 5, 6]     ← Acumula anteriores
  Fase 5: [3, 4, 5, 6, 7]  ← Acumula anteriores
...
# ============================================================================
parser = argparse.ArgumentParser(description='Experimento 8: Curriculum Intermedios Acumulativo')
...
# CONFIGURACIÓN DEL EXPERIMENTO: Curriculum acumulativo solo niveles intermedios
PHASE_LEVELS = [
    [3],                # Fase 1: Solo nivel 3
    [3, 4],             # Fase 2: Acumula 3 y 4
    [3, 4, 5],          # Fase 3: Acumula 3, 4 y 5
    [3, 4, 5, 6],       # Fase 4: Acumula 3, 4, 5 y 6
    [3, 4, 5, 6, 7],    # Fase 5: Todos los intermedios
]

OUTPUT_DIR = f"./resultados/exp8_results_{config.name}"
...
def main():
    print("="*80)
    print(f"EXPERIMENTO 8: Curriculum Intermedios Acumulativo - {config.name}")
    print("="*80)
    ...
    print(f"Estrategia: Curriculum acumulativo (overlap 100%)")
    ...
    for phase in range(N_PHASES):
        ...
        if phase > 0:
            print(f" Acumula niveles de fases anteriores")
        print('='*80)
    ...
    results = {
        'experiment': 'exp8_curriculum_intermedios_acumulativo',
        'dataset': config.name,
        ...
        'strategy': 'curriculum_intermedios_acumulativo'
    }
